...
分布式版本下载地址[ossimport-2.3.3.tar.gz](http://gosspublic.alicdn.com/ossimport/distributed/ossimport-2.3.3.tar.gz)，下载到本地后，使用命令 `tar -zxvf ossimport-2.3.2.tar.gz -C $HOME/ossimport` 解压，解压后的文件结构如下：
