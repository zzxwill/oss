...
-   登录[OSS管理控制台](https://oss.console.aliyun.com/)，在OSS概览页右边单击**设置报警规则**，进入OSS监控服务。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4392/15528939976368_zh-CN.png)

-   直接进入[云监控控制台](https://cloudmonitor.console.aliyun.com)查看OSS监控服务。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4392/15528939976369_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4392/15528939976370_zh-CN.jpg)

该页面没有自动刷新功能，可以单击右上角的**刷新**按钮自动更新数据信息。

单击**前往对象存储OSS控制台**可以直接进入OSS控制台界面。

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4392/15528939976371_zh-CN.jpg)
...
-   用户监控信息
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4392/15528939976372_zh-CN.jpg)
...
-   当月计量统计
    ...
    -   Put类请求数
    -   Get类请求数
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4392/15528939976374_zh-CN.jpg)

    各个计量框中展示的数据根据量级自动调整单位，鼠标停留在数字上方会显示精确的数值。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4392/15528939976375_zh-CN.jpg)

-   用户层级监控指标

    该模块主要展示具体的用户层级的监控图表，主要包括服务监控总览和请求状态详情两部分，下面会详细介绍。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4392/15528939976376_zh-CN.jpg)

    图表展现提供了快速时间范围选择按钮和自定义时间框。

    -   快速时间范围选择按钮提供1小时、6小时、12小时、1天和7天的时间范围选择，默认为1小时。
    -   自定义时间框可以自定义起始时间和结束时间，精确到分钟级别。注意，不支持查询8天以前的数据。
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4392/15528939986377_zh-CN.jpg)

    图表展示还支持以下功能：

    -   单击相关图例可以将该指标曲线隐去，如下图：

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4392/15528939986378_zh-CN.jpg)
    ...
    -   鼠标按住图形曲线区域拖放，可以进行时间范围快速调整放大，单击**恢复缩放**回归到拖放之前的时间范围。![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4392/15528939986379_zh-CN.jpg)
-   服务监控总览
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4392/15528939984334_zh-CN.jpg)
...
-   请求状态详情
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4392/15528939986380_zh-CN.png)
...
-   Bucket列表信息
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4392/15528939986381_zh-CN.jpg)
...
-   Bucket层级监控视图
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4392/15528939986382_zh-CN.png)
    ...
    -   服务监控总览
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4392/15528939986383_zh-CN.jpg)
    ...
    -   请求状态详情
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4392/15528939984331_zh-CN.jpg)

    -   计量参考

        计量参考分组展示各个计量相关的指标信息，以小时粒度收集展现，如下图所示：

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4392/15528939981210_zh-CN.png)
    ...
    -   平均延时
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4392/15528939981212_zh-CN.png)
    ...
    -   最大延时
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4392/15528939981213_zh-CN.png)
    ...
    -   成功请求操作分类
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4392/15528939981214_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4392/15528939991215_zh-CN.png)
