...
-   为防止第三方未经授权向开发者的Bucket上传Object，OSS提供了Bucket和Object级别的访问权限控制，详情请参见[OSS细粒度的权限控制](https://help.aliyun.com/knowledge_detail/57754.html)。

-   为了授权给第三方上传，这里使用的是Post Policy的机制，详情请参见[PostObject](../../../../cn.zh-CN/API 参考/关于Object操作/PostObject.md#)。
