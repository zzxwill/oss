...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4405/15368419241472_zh-CN.png)
...
具体操作步骤请参见[设置跨域访问](../../../../cn.zh-CN/控制台用户指南/管理存储空间/设置跨域访问.md#)。设置如下图所示：

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4405/15368419241488_zh-CN.png)
...
-   上传签名
    ...
    **说明：** Policy的详细信息请参见[Policy语法结构](../../../../cn.zh-CN/用户指南/授权策略语言/Policy 语法结构.md#)。
...
本示例中，web端向服务端请求签名，然后直接上传，不会对服务端产生压力，而且安全可靠。但是这个示例有个问题，就是用户上传了多少文件，上传了什么文件，服务端并不能马上知道，如果想实时了解用户上传了什么文件，可以采用[服务端签名直传并设置上传回调](cn.zh-CN/最佳实践/Web端直传实践/服务端签名直传并设置上传回调.md#)。
