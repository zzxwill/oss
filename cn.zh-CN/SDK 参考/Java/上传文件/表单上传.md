# 表单上传 {#concept_84788_zh .concept}

表单上传是使用HTML表单形式上传文件到指定存储空间中，文件最大不能超过5GB。

表单上传的适用场景介绍请参见开发指南中的[表单上传](../../../../cn.zh-CN/开发指南/上传文件/表单上传.md#)。

PostObject更多详情请参见[Java模拟PostObject表单上传OSS](https://yq.aliyun.com/articles/30346?spm=5176.team4.teamshow1)。
...
**说明：** 更多回调详情请参见[Callback](../../../../cn.zh-CN/API 参考/关于Object操作/Callback.md#)。
