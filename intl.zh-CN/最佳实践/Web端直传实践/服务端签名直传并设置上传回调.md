...
-   upload.js文件
    ...
    将变量severUrl改成服务器部署的地址，用于处理浏览器和应用服务器之间的通信。例如severUrl = `[http://abc.com:8080/oss-h5-upload-js-php-callback/get.php](http://abc.com:8080/oss-h5-upload-js-php-callback/get.php)`。
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4405/15329383071488_zh-CN.png)
