...
2.  单击**图片处理**页签，找到**访问设置**按钮。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4792/154149417721862_zh-CN.png)

3.  单击**访问设置**，打开设置窗口。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4792/15414941772883_zh-CN.png)
...
-   直接参数访问
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4792/15414941772884_zh-CN.jpg)
...
-   通过URL参数，使用样式访问
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4792/15414941772885_zh-CN.jpg)
