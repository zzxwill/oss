# 上传回调 {#concept_91107_zh .concept}

本文介绍如何使用上传回调。

上传回调的完整代码请参见[GitHub](https://github.com/aliyun/aliyun-oss-csharp-sdk/blob/master/samples/Samples/UploadCallbackSample.cs)。
...
**说明：** 上传回调详情请参见开发指南中的[上传回调](../../../../cn.zh-CN/开发指南/上传文件/上传回调.md#)。
