...
-   方式一：使用AppServer来做数据中转和数据隔离
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4347/1538290687982_zh-CN.png)
...
-   方式二：使用STS让用户直接访问OSS
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4347/1538290688983_zh-CN.png)
