...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4347/1549849597983_zh-CN.png)
...
1.  创建用户子账号。
    ...
    4.  在新建用户页面，用户账号信息填写**登录名称**、**显示名称**，访问方式下勾选**编程访问**，并单击**确定**。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/80860/154984959735383_zh-CN.jpg)

    5.  单击**权限管理** \> **添加权限**。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/80860/154984959735405_zh-CN.jpg)

    6.  在添加权限页面，为已创建子账号添加**AliyunSTSAssumeRoleAccess** 权限。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/80860/154984959735411_zh-CN.jpg)
...
2.  创建权限策略。
    ...
    4.  在新建自定义权限策略页面，填写**策略名称**、**备注**，配置模式选择**可视化配置**或**脚本配置**。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/80860/154984959735423_zh-CN.jpg)
...
3.  创建角色。
    ...
    4.  在新建 RAM 角色页面，填写**RAM 角色名称**，本示例 RAM 角色名称为 RamOssTest，选择可信实体类型及受信云账号 ID 保留默认选项。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/80860/154984959735434_zh-CN.jpg)
    ...
    6.  在添加权限页面，选择**自定义权限策略**，添加步骤 2 中创建的策略 Ramtest。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/80860/154984959735437_zh-CN.jpg)
