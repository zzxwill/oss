...
For OSS external resource url, see [OSS address](../../../../../reseller.en-US/Developer Guide/Signature/OSS request process.md#) such a URL \(without signing\) requires the user's bucket permission to read publicly.
...
-   Anti-leech effects of different Referer settings
    ...
    -   Disable Allow Empty Referer, as shown in the following figure:
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4411/15498783481701_en-US.png)
    ...
    -   Disable Allow Empty Referer and configure a Referer whitelist.
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4411/15498783481702_en-US.png)
    ...
    -   Enable Allow Empty Referer and configure a Referer whitelist.
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4411/15498783481709_en-US.png)
...
-   How to configure Referer on OSS
    ...
    -   API: [Put Bucket Referer](../../../../../reseller.en-US/API Reference/Bucket operations/Put Bucket Referer.md#)
...
-   Record access logs of the bucket, so that you can promptly discover leeching and verify the effectiveness of your anti-leeching solution. For access log information, see [Access logging configuration](../../../../../reseller.en-US/Developer Guide/Access and control/Overview.md#).
