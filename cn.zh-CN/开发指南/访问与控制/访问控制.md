...
目前访问 OSS 使用的 AK（[AccessKey](cn.zh-CN/开发指南/基本概念介绍.md#section_u3j_nmt_tdb)）有三种类型，具体如下：
...
-   Bucket权限设定和读取方法
    ...
    -   SDK：Java SDK-[设置Bucket ACL](https://help.aliyun.com/document_detail/32012.html)
    -   控制台：[创建Bucket](../../../../cn.zh-CN/控制台用户指南/管理存储空间/创建存储空间.md#)权限设置
    -   API：[Get BucketACL](../../../../cn.zh-CN/API 参考/关于Bucket的操作/GetBucketAcl.md#)
    -   SDK：Java SDK-[获取Bucket ACL](https://help.aliyun.com/document_detail/32012.html)
...
-   Object权限设定和读取方法
    ...
    -   API：[Put Object ACL](../../../../cn.zh-CN/API 参考/关于Object操作/PutObjectACL.md#)
    -   SDK：Java SDK-[ObjectACL](https://help.aliyun.com/document_detail/32015.html) 中设定Object ACL
    -   API：[Get Object ACL](../../../../cn.zh-CN/API 参考/关于Object操作/GetObjectACL.md#)
    -   SDK：Java SDK-[ObjectACL](https://help.aliyun.com/document_detail/32015.html) 中读取Object ACL
...
-   具体实现
    ...
    有关RAM详情，请参考[RAM用户手册](https://help.aliyun.com/document_detail/28645.html?spm=a2c4g.11186623.2.15.VMkTIw)。
...
-   具体实现
    ...
    STS安全令牌、角色管理和使用相关内容详情，请参考RAM用户指南中的[角色管理](https://help.aliyun.com/document_detail/28649.html)。关键是调用STS服务接口[AssumeRole](https://help.aliyun.com/document_detail/28763.html)来获取有效访问凭证即可，也可以直接使用STS SDK来调用该方法。
...
针对具体场景更多的授权策略配置示例，可以参考[教程示例：控制存储空间和文件夹的访问权限](cn.zh-CN/开发指南/访问与控制/教程示例：控制存储空间和文件夹的访问权限.md#)和[OSS授权常见问题](https://help.aliyun.com/knowledge_detail/58905.html)。
