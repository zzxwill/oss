...
-   方式一：使用 AppServer 来做数据中转和数据隔离
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4347/1542784033982_zh-CN.png)
...
-   方式二：使用 STS 让用户直接访问 OSS
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4347/1542784033983_zh-CN.png)
