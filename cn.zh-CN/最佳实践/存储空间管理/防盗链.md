...
-   不同的Referer设置和防盗链效果
    ...
    -   只设置“不允许referer为空”
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4411/15541978121701_zh-CN.png)
    ...
    -   设置“不允许referer为空”的同时也设置Referer白名单
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4411/15541978121702_zh-CN.png)
    ...
    -   设置“允许referer为空”的同时也设置Referer白名单
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4411/15541978121709_zh-CN.png)
...
-   记录Bucket访问日志，能够及时发现盗链活动和验证防盗链方案的有效性。访问日志参见[实时记录查询](../../../../../intl.zh-CN/开发指南/日志管理/实时日志查询.md#)。
