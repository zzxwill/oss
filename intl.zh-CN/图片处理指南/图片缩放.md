...
-   将图缩略成高度为100，宽度按比例处理。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4769/15330184842414_zh-CN.jpg)
...
-   将图最长边限制在100像素，短边按比例处理。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4769/15330184852415_zh-CN.jpg)
...
-   将图强制缩略成宽度为100，高度为100。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4769/15330184852416_zh-CN.jpg)
...
-   将图缩略成宽度为100，高度为100，按长边优先。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4769/15330184852418_zh-CN.png)
...
-   将图缩略成宽度为100，高度为100，按长边优先，将图片保存成png格式。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4769/15330184852419_zh-CN.png)
...
-   将图缩略成宽度为100，高度为100，按短边优先。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4769/15330184852420_zh-CN.jpg)
...
-   将图自动裁剪成宽度为100，高度为100的效果图。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4769/15330184852421_zh-CN.jpg)
...
-   将原图指定按短边缩略100x100, 剩余的部分以单色填充。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4769/15330184852422_zh-CN.jpg)
...
-   将图按短边缩略到100x100, 然后按红色填充。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4769/15330184852423_zh-CN.jpg)
...
-   将图按比例缩略到原来的1/2。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4769/15330184852425_zh-CN.jpg)
