...
2.  Create roles. Here you must create two roles for users to perform read operations and to upload files respectively.
    ...
    -   Select a role type. Here you must select **User role**.![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4419/15528883896283_en-US.png)
    -   Enter the role type information. Because this role has been used by its own Alibaba Cloud account. Use the default setting.
    -   Configure basic role information.![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4419/15528883896284_en-US.png)
3.  When the role was created, it did not have any permissions. Therefore, we must create a custom authorization policy using the process described earlier. The following is the authorization policy:
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4419/15528883896285_en-US.png)

4.  After the policy is established, give the role RamTestAppReadOnly the ram-test-app read-only permission on the role management page.![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4419/15528883896286_en-US.png)

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4419/15528883896287_en-US.png)
...
5.  Perform the same procedure to create the role RamTestAppWrite and use a custom authorization policy to grant ram-test-app write permission. The authorization policy is as follows:
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4419/15528883896288_en-US.png)
...
1.  Create two custom authorization policies in authorization policy management.![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4419/15528883896289_en-US.png)
