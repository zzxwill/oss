...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4405/15329400761488_zh-CN.png)
...
2.  在Web浏览器中输入`<Web应用服务器地址>/oss-h5-upload-js-php/index.html`，例如`http://abc.com/oss-h5-upload-js-php/index.html`。
3.  选择一个或多个文件进行上传。
4.  上传成功后，通过控制台查看上传结果。
