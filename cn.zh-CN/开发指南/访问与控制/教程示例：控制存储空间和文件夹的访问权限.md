# 教程示例：控制存储空间和文件夹的访问权限 {#concept_rf2_251_5db .concept}
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4349/3896_zh-CN.png)
...
-   当您将名为**ProjectA.docx**的对象上传到**Development**文件夹中时，控制台会上传该对象并将其key设置为`Development/ProjectA.docx`。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4349/1187_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4349/1188_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4349/1189_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4349/1190_zh-CN.png)
...
4.  测试权限。
    ...
    3.  单击 example-company 存储空间，然后单击**文件**选项卡。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4349/1193_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4349/1195_zh-CN.png)
...
3.  测试更新的权限。
    ...
    3.  单击 example-company 存储空间，然后单击**文件**选项卡。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4349/1196_zh-CN.png)
