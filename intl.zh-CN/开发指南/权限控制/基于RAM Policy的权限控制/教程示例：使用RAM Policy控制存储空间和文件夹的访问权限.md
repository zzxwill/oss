...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4349/15519453603896_zh-CN.png)
...
-   当您将名为 ProjectA.docx 的对象上传到 Development 文件夹中时，控制台会上传该对象并将其key设置为`Development/ProjectA.docx`。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4349/15519453601187_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4349/15519453601188_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4349/15519453601189_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4349/15519453601190_zh-CN.png)
...
2.  在左侧导航栏中，单击**概览**。
3.  在 RAM 用户登录链接 后找到 URL。您将向 RAM 用户提供此 URL，以便其使用 RAM 用户名和密码登录控制台。
...
2.  创建名为 **example-company** 的存储空间。
    ...
    有关详细过程，请参见 OSS 控制台用户指南中的[创建存储空间](../../../../../intl.zh-CN/控制台用户指南/管理存储空间/创建存储空间.md#) 。
...
2.  创建策略 AllowGroupToSeeBucketListInConsole。
    ...
    2.  单击**空白模板**。
    3.  在**授权策略名称**字段中，输入 AllowGroupToSeeBucketListInConsole。
    4.  在策略内容字段中，复制并粘贴以下策略。
        ...
        **说明：** 
        ...
        -   推荐您使用 [RAM 策略编辑器](../../../../../intl.zh-CN/常用工具/RAM策略编辑器.md#)快速生成 RAM 策略。更详细的 RAM 策略介绍请参见[如何构建 RAM Policy](intl.zh-CN/开发指南/权限控制/基于RAM Policy的权限控制/如何构建RAM Policy.md#)。
...
4.  测试权限。
    ...
    3.  单击 example-company 存储空间，然后单击**文件**选项卡。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4349/15519453601193_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4349/15519453601195_zh-CN.png)
...
3.  测试更新的权限。
    ...
    3.  单击 example-company 存储空间，然后单击**文件**选项卡。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4349/15519453601196_zh-CN.png)
...
3.  将策略分配给 RAM 用户 Anne。
    ...
    有关分配策略的详细过程，请参见 RAM 快速入门中的[将策略分配给 RAM 用户](../../../../../intl.zh-CN/快速入门/为 RAM 用户授权.md#)。
...
有关详细过程，请参见 RAM 用户指南中[用户](../../../../../intl.zh-CN/用户指南/身份管理/用户.md#)的“删除 RAM 用户”部分。
