...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4909/15483805233009_zh-CN.jpg)
...
-   返回的Body非JSON格式
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4909/154838052338047_zh-CN.png)

    错误原因有以下两种情况。

    -   应用服务器返回给OSS的Body不是JSON格式。如下图所示：

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4909/154838052338048_zh-CN.png)
    ...
    -   应用服务器返回给OSS的Body中带有bom头。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4909/154838052338049_zh-CN.png)
...
-   错误的status
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4909/154838052338050_zh-CN.png)
...
-   超时
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4909/154838052338051_zh-CN.png)
