...
2.  客户端拿到签名直接上传到OSS。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4405/1472_zh-CN.png)
...
1.  设置成自己的id、key、bucket。
    ...
    -   $host设置成：bucket+endpoint
        ...
        **说明：** 关于endpoint，请参见 [基本概念介绍](../cn.zh-CN/开发指南/基本概念介绍.md#)。
...
2.  为了浏览安全，必须为bucket设置CORS。
    ...
    **说明：** 一定要保证bucket属性CORS设置支持POST方法。因为这个HTML直接上传到OSS，会产生跨域请求。必须在bucket属性里面设置允许跨域。
    ...
    具体操作步骤请参见 [设置跨域访问](../cn.zh-CN/控制台用户指南/管理存储空间/设置跨域访问.md#)。设置如下图：

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4405/1488_zh-CN.png)
...
-   [基本概念](../cn.zh-CN/开发指南/基本概念介绍.md#)
-   [设置跨域访问](../cn.zh-CN/控制台用户指南/管理存储空间/设置跨域访问.md#)
-   [Web端直传实践简介](cn.zh-CN/最佳实践/Web端直传实践/Web端直传实践简介.md#)
-   [JavaScript客户端签名直传](cn.zh-CN/最佳实践/Web端直传实践/JavaScript客户端签名直传.md#)
-   [进阶篇：应用服务器php返回签名及采用上传回调](cn.zh-CN/最佳实践/Web端直传实践/服务端签名直传并设置上传回调.md#)
-   [移动应用端直传实践](cn.zh-CN/最佳实践/移动应用端直传实践/快速搭建移动应用直传服务.md#)
