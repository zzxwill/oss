...
Region 表示 OSS 的数据中心所在的地域，物理位置。用户可以根据费用、请求来源等综合选择数据存储的 Region。一般来说，距离用户更近的 Region 访问速度更快。详情请查看[OSS 已经开通的 Region](cn.zh-CN/开发指南/访问域名和数据中心.md#)。
...
更多 AccessKey 介绍请参见[访问控制](cn.zh-CN/开发指南/访问与控制/访问控制.md#)。
