...
在浏览器中可以根据document.getElementById\(“file”\).files\[0\].size 获取上传文件的大小（字节数），可参考[Web端直传实践](../../../../../intl.zh-CN/最佳实践/Web端直传实践/Web端直传实践简介.md#)的post请求。

## 如何获取上传进度 {#section_cpt_y5y_pgb .section}

使用分片上传时，可获取[上传进度](intl.zh-CN/SDK 参考/Browser.js/上传文件.md#)。
...
更多上传回调请参见[原理介绍](../../../../../intl.zh-CN/最佳实践/Web端直传实践/服务端签名直传并设置上传回调/原理介绍.md#)。
