...
2.  You must set CORS for the bucket to guarantee browser safety.
    ...
    **Note:** In earlier-version IE browsers, Plupload is executed in flash. You must set crossdomain.xml. [https://yq.aliyun.com/articles/3198](https://yq.aliyun.com/articles/3198)
