...
3.  When the role was created, it did not have any permissions. Therefore, we must create a custom authorization policy using the process described earlier.  The following is the authorization policy:
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4419/6285_en-US.png)

4.  After the policy is established, give the role RamTestAppReadOnly the ram-test-app read-only permission on the role management page.![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4419/6286_en-US.png)

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4419/6287_en-US.png)
...
5.  Perform the same procedure to create the role RamTestAppWrite and use a custom authorization policy to grant ram-test-app write permission. The authorization policy is as follows:
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4419/6288_en-US.png)
