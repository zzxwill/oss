...
-   binary下载
    -   [Linux x86 32bit](http://gosspublic.alicdn.com/ossutil/1.5.1/ossutil32)
    -   [Linux x86 64bit](http://gosspublic.alicdn.com/ossutil/1.5.1/ossutil64) 

        **说明：** 复制链接的时候，会自动加上spm编码内容，使用wget命令下载的时候，注意删除链接中?spm=xxxx内容。

    -   [Windows x86 32bit](http://gosspublic.alicdn.com/ossutil/1.5.1/ossutil32.zip)
    -   [Windows x86 64bit](http://gosspublic.alicdn.com/ossutil/1.5.1/ossutil64.zip)
    -   [mac x86 32bit](http://gosspublic.alicdn.com/ossutil/1.5.1/ossutilmac32)
    -   [mac x86 64bit](http://gosspublic.alicdn.com/ossutil/1.5.1/ossutilmac64)
...
-   Linux系统\(以64位系统为例\)
    1.  下载工具：
        ...
        ```
        wget http://gosspublic.alicdn.com/ossutil/1.5.1/ossutil64
...
-   Mac系统（以64位系统为例）：
    1.  下载工具。
        ...
        ```
        curl -o ossutilmac64 http://gosspublic.alicdn.com/ossutil/1.5.1/ossutilmac64
        ```
