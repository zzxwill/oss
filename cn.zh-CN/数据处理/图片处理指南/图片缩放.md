...
-   单边缩略
    -   按宽高：将图缩略成高度为 100，宽度按比例处理。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4769/15474500112414_zh-CN.jpg)
    ...
    -   按长边短边：将图最长边限制在 100 像素，短边按比例处理。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4769/15474500112415_zh-CN.jpg)
...
-   强制宽高缩略：将图强制缩略成宽度为 100，高度为 100。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4769/15474500112416_zh-CN.jpg)
...
-   等比缩放，限定在矩形框内
    -   将图缩略成宽度为 100，高度为 100，按长边优先。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4769/15474500112418_zh-CN.png)
    ...
    -   将图缩略成宽度为 100，高度为 100，按长边优先，将图片保存成 png 格式。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4769/15474500112419_zh-CN.png)
...
-   等比缩放，限定在矩形框外
    -   将图缩略成宽度为 100，高度为 100，按短边优先。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4769/15474500112420_zh-CN.jpg)
...
-   固定宽高，自动裁剪
    -   将图自动裁剪成宽度为 100，高度为 100 的效果图。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4769/15474500112421_zh-CN.jpg)
...
-   固定宽高，缩略填充
    -   将原图指定按短边缩略 100x100，剩余的部分以白色填充。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4769/15474500122422_zh-CN.jpg)
    ...
    -   将图按短边缩略到 100x100，然后按红色填充。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4769/15474500122423_zh-CN.jpg)
...
-   将图按比例缩略到原来的 1/2。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4769/15474500122425_zh-CN.jpg)
